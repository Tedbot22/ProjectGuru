...
function Portfolio() {
  ...
  const projects = [{ title: "Project", description: "Glory | DELSU", bg: thumb1, fileLink: doc1 },
  { title: "IT Report", description: "Chioma | UNICAL", bg: thumb2, fileLink: doc2 },
  { title: "Project", description: "Christiana | UNIPORT", bg: thumb3, fileLink: doc3 },
  { title: "Seminar", description: "Miracle | DELSU.", bg: thumb4, fileLink: doc4 },
  { title: "Seminar", description: "Ebenezer | UNICAL", bg: thumb5, fileLink: doc5 },
  { title: "IT Report", description: "Odirah | UNILAG", bg: thumb6, fileLink: doc6 },
  { title: "Project", description: "Austine | DELSU", bg: thumb7, fileLink: doc7 },
