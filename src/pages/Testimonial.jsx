...
function Testimonial() {
  ...
  { id: 3, name: "David Esther", rating: 5, review: "just wanted to let you know i got my result today. I passed! Thank you for putting in the effort because i know this wasn't an easy topic. You delivered exactly what i needed, Thank you so much.", departmet: "Biochemistry", institution: "Delsu", year: "2026", logoColor: "#d14222" },
  { id: 4, name: "James Believe", rating: 4, review: "I can't even lie, i was expecting to make plenty corrections, but i barely changed anything. The quality waas really good, my supervisor really liked the work.", departmet: "Accounting", institution: "Unilag", year: "2025", logoColor: "#11238a" },
  { id: 5, name: "Onyebuchi Judith", rating: 5, review: "Just wanted to say a huge thank you. the feedback from the lecturer was really positive and i'm gunuiely happy with the outcome", departmet: "Anatomy", institution: "Delsu", year: "2026", logoColor: "#2065cc" }]
